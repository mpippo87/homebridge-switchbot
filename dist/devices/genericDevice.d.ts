...
export declare class WaterDetectorDevice extends GenericDevice {
    ...
    private _batteryRefreshing;
    private _batteryRefreshTs;
    private readonly BATTERY_REFRESH_TTL_MS;
    init(): Promise<void>;
    private normalizeLeakDetected;
    private normalizeBatteryLevel;
    private getOpenAPIStatus;
    private readLeakDetected;
    private readBatteryLevel;
    private _refreshLeakState;
    private _refreshBattery;
    private getLeakDetectedFast;
    private getBatteryFast;
    createHAPAccessory(api: any): {
        services: ({
            type: string;
            characteristics: {
